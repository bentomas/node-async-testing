...
exports.run = function(list, args, cb) {
  ...
  flags['Behavior'] =
    ...
    , { longFlag: 'web'
      , shortFlag: 'w'
      , description: 'launch the web runner for running tests from your browser'
      }
    , { longFlag: 'help'
      , shortFlag: 'h'
  ...
  var web = require('./web-runner')
    , terminal = require('./console-runner')
    ;

  flags['Console Runner'] = terminal.flags;
  flags['Web Runner'] = web.flags;
