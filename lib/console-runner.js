  ...
  opts =
    ...
    , onSuiteDone: function(suiteResults) {
        ...
        if (options.verbosity == 0) {
          ...
          console.log(last + ' ' + ((new Date() - lastStart)/1000) + ' seconds.');
          console.log('');
        }
      }
    ...
    , onDone: function(allResults) {
        ...
        console.log(last + bold(' ' + tests+(tests == 1 ? ' test' : ' total tests')+'. '+((new Date() - start)/1000)+' seconds.'));
