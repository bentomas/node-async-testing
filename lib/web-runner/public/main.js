...
(function() {
  ...
  var handlers =
    ...
    , suiteStart: function(obj) {
        ...
        curSuite.runSpan.innerText = 'Running [';
    ...
    , suiteDone: function(obj) {
        ...
        curSuite.runSpan.innerText = 'Run';
    ...
    , suiteError: function(obj) {
        ...
        curSuite.runSpan.innerText = 'Error running';
  ...
  function buildSuiteElement(suite) {
    ...
    if (suite.error) {
      ...
      runSpan.innerText = 'Error: ' + (suite.error.lineno ? 'line ' + suite.error.lineno + ' - ' : '') + suite.error.message;
