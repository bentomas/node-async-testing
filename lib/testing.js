...
<<<<<<< HEAD
      /*  //test time out method... so can handle time out like it's an error from within test.
      , timeoutHandler: function (test){
        		throw new Error ("test " + test + "failed because test.finish() never called");
        }*/
      , finish: function() { curTest.finish(); }
=======
      , finish: function() { testProgressed(test); }
>>>>>>> e44948723d64072860074110b3158e4d01e66c74
      };
...
//    if (!options.parallel && suite.started[0] && suite.started[0].UEHandler) {
...
>>>>>>> f08f89c20354b20cc568dfb126a92ecb733274ea
      }
    }
  }
